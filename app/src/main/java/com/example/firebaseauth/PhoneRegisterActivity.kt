...
import com.example.firebaseauth.databinding.ActivityPhoneRegisterBinding
...
class PhoneRegisterActivity : AppCompatActivity() {
    ...
    private val TAG = "PhoneRegisterActivity"
    ...
    private fun verifyCode(){
        val code = binding.smsCodeEt.toString()
        if (code.length == 6){
